...
/// active : 21131447
/// critical : 38126
/// casesPerOneMillion : 89340
/// deathsPerOneMillion : 888.4
/// tests : 7007375682
/// testsPerOneMillion : 881992.81
/// population : 7944935131
/// oneCasePerPeople : 0
/// oneDeathPerPeople : 0
/// oneTestPerPeople : 0
/// activePerOneMillion : 2659.74
/// recoveredPerOneMillion : 84120.48
/// criticalPerOneMillion : 4.8
/// affectedCountries : 231

WordStateModel wordStateModelFromJson(String str) => WordStateModel.fromJson(json.decode(str));
...
WordStateModel copyWith({  num? updated,
  num? cases,
  num? todayCases,
  num? deaths,
  num? todayDeaths,
  ...
  num? criticalPerOneMillion,
  num? affectedCountries,
}) => WordStateModel(  updated: updated ?? _updated,
  cases: cases ?? _cases,
